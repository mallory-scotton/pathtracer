...
SplitBvh::SahSplit SplitBvh::FindObjectSahSplit(
    SplitRequest const& req, PrimRefArray const& refs) const {
    // SAH implementation
...
bool SplitBvh::SplitPrimRef(PrimRef const& ref, int axis, float split,
...
void SplitBvh::SplitPrimRefs(SahSplit const& split, SplitRequest const& req,
